...
const Login = () => {
  const { signInUsingGoogle, setIsLoading, handleRegistration, handleEmailChange, handlePasswordChange, error, handleResetPassword, processLogin} = useAuth();
  ...
  return (
    <div className="login-form">
      <div>
        ...
        </div><div className="row mb-3 text-danger">{error}</div>
